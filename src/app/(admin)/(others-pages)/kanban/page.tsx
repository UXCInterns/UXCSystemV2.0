...
import KanbanBoard, { initialColumns } from "@/components/kanban/KanbanBoard";
...
export default function Kanban() {
  ...
  const handleAddTask = (task: { title: string; description: string; date: string; status: string; }) => {
    setColumns((prevCols) =>
      prevCols.map((col) =>
          ...
          header={
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-4 mr-4">
                ...
                >
                  Add New Task <PlusIcon className="ml-2" />
                </button>
              </div>
            </div>
          }
