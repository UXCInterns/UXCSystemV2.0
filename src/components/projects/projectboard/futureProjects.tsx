...
interface FutureProjectsTableProps {
  searchQuery: string;
  selectedSort: string;
  onSortChange: (value: string) => void;
} 

export default function FutureProjectsTable({
  searchQuery,
  selectedSort,
  onSortChange,
}: FutureProjectsTableProps) {
  const [tableData, setTableData] = useState<Visit[]>(futureData);
