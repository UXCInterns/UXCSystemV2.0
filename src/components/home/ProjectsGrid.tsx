...
export const ProjectsGrid = () => {
  ...
  const getStatusConfig = (status: string) => {
    ...
    const configs: Record<string, { icon: React.ReactElement; badgeColor: BadgeColor }> = {
      'In Progress': {
        icon: <TrendingUpIcon className="w-3 h-3 sm:w-3.5 sm:h-3.5" />,
        badgeColor: 'primary',
      },
      'Not Started': {
        icon: <ClockIcon className="w-3 h-3 sm:w-3.5 sm:h-3.5" />,
        badgeColor: 'light' as BadgeColor,
      },
      'Completed': {
        icon: <CheckCircle2Icon className="w-3 h-3 sm:w-3.5 sm:h-3.5" />,
        badgeColor: 'success',
      },
      'On Hold': {
        icon: <PauseCircleIcon className="w-3 h-3 sm:w-3.5 sm:h-3.5" />,
        badgeColor: 'warning',
      },
      'Cancelled': {
        icon: <XCircleIcon className="w-3 h-3 sm:w-3.5 sm:h-3.5" />,
        badgeColor: 'error',
      },
    };
        ...
        <div className="p-3 sm:p-4 md:p-5 border-b border-gray-100 dark:border-gray-800">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div className="space-y-2 w-full sm:w-auto">
              <div className="h-5 sm:h-6 bg-gray-200 rounded dark:bg-gray-700 w-32 animate-pulse" />
              <div className="h-3 sm:h-4 bg-gray-200 rounded dark:bg-gray-700 w-40 sm:w-56 animate-pulse" />
            </div>
            <div className="h-6 sm:h-7 bg-gray-200 rounded-full dark:bg-gray-700 w-20 sm:w-24 animate-pulse" />
          </div>
        </div>
        ...
        <div className="p-3 sm:p-4 md:p-5">
          <div className="grid grid-cols-1 gap-3 sm:gap-4 md:gap-5 md:grid-cols-2 lg:grid-cols-3">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="rounded-xl border border-gray-200 bg-white p-4 sm:p-5 dark:border-gray-700 dark:bg-white/[0.02] animate-pulse"
              >
                <div className="h-4 sm:h-5 bg-gray-200 rounded dark:bg-gray-700 w-3/4 mb-3" />
                <div className="h-3 sm:h-4 bg-gray-200 rounded dark:bg-gray-700 w-full mb-2" />
                <div className="h-3 sm:h-4 bg-gray-200 rounded dark:bg-gray-700 w-2/3" />
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="rounded-xl sm:rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] overflow-hidden">
        ...
        <div className="p-8 sm:p-12">
          <div className="text-center">
            <AlertCircleIcon className="w-10 h-10 sm:w-12 sm:h-12 mx-auto text-gray-400 dark:text-gray-600 mb-3" />
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] overflow-hidden">
      ...
      {/* Projects Grid */}
      <div className="p-5 h-auto sm:h-[341px] overflow-y-auto">
        {filteredProjects.length === 0 ? (
          ...
          <div className="grid grid-cols-1 gap-3 sm:gap-4 md:gap-5 md:grid-cols-2 lg:grid-cols-3 overflow-y-auto custom-scrollbar pr-1 sm:pr-2">
            {filteredProjects.map((project) => {
              ...
              return (
                <div
                  key={project.id}
                  className="group relative rounded-xl sm:rounded-2xl border border-gray-200 bg-gradient-to-br from-white to-purple-50/30 p-4 sm:p-5 transition-all duration-300 hover:shadow-lg hover:shadow-purple-100/50 dark:border-gray-800 dark:from-white/[0.03] dark:to-purple-900/[0.05] dark:hover:shadow-purple-900/20 active:scale-[0.98] touch-manipulation"
                >
                  {/* Header */}
                  <div className="mb-3 sm:mb-4">
                    <div className="flex items-start justify-between gap-2 mb-2 sm:mb-3">
                      <h3 className="text-sm sm:text-base font-semibold text-gray-900 dark:text-white line-clamp-2 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
                  ...
                  <div className="mb-3 sm:mb-4">
                    ...
                    <div className="h-1.5 sm:h-2 bg-gray-200 rounded-full overflow-hidden dark:bg-gray-700">
                      <div
                  ...
                  {/* Footer Info */}
                  <div className="space-y-2 sm:space-y-3 pt-2 sm:pt-3 border-t border-gray-100 dark:border-gray-700">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Badge 
                        ...
                        size="sm" 
                        color={timeColor}
                        startIcon={<ClockIcon className="w-2.5 h-2.5 sm:w-3 sm:h-3" />}
                      >
                        {timeText}
                      </Badge>
                    </div>
                    ...
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <div className="flex items-center gap-1 sm:gap-1.5">
                        <div className="flex -space-x-1.5 sm:-space-x-2">
                          ...
                          {totalTeamSize > 3 && (
                            <div 
                              className="w-6 h-6 sm:w-7 sm:h-7 rounded-full border-2 border-white dark:border-gray-900 bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center text-[9px] sm:text-[10px] font-bold text-white shadow-sm cursor-pointer hover:scale-110 transition-transform"
