    ...
    <div className="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] overflow-hidden h-full flex flex-col">
      ...
      <div className="p-5">
        {filteredTasks.length === 0 ? (
          ...
          <div className="space-y-4 max-h-[485px] overflow-y-auto custom-scrollbar pr-2">
            {filteredTasks.map((task) => {
              ...
              return (
                <div
                  key={task.task_id}
                  className={`group relative rounded-2xl border border-gray-200 bg-gradient-to-br from-white to-cyan-50/30 p-5 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-100/50 dark:border-gray-800 dark:from-white/[0.03] dark:to-cyan-900/[0.05] dark:hover:shadow-cyan-900/20`}
                >
                  {/* Task Header */}
