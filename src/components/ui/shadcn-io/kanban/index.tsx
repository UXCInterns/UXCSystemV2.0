    ...
    <>
        ...
        >
          {children ?? (
            <div className="space-y-2">
              <p className="font-semibold text-sm leading-tight text-gray-900 dark:text-white">{name}</p>
            </div>
          )}
        </Card>
      </div>
      {activeCardId === id && (
        <t.In>
          <Card
            className={cn(
              'cursor-grab rounded-lg p-3 bg-white dark:bg-gray-800/50 border-gray-200 dark:border-gray-700 shadow-lg ring-2 ring-blue-500 dark:ring-blue-400',
...
export const KanbanHeader = ({ className, ...props }: KanbanHeaderProps) => (
  <div className={cn('font-semibold text-xs uppercase tracking-wider text-gray-600 dark:text-gray-400', className)} {...props} />
);
  ...
  return (
    <KanbanContext.Provider value={{ columns, data, activeCardId }}>
      ...
      >
        <div
          className={cn(
            'grid size-full auto-cols-fr grid-flow-col gap-1',
            className
          )}
        >
