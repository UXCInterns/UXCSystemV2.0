...
const NewWorkshopForm: React.FC<NewWorkshopFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        setNotificationMessage("Workshop created successfully!");
        setShowNotification(true);
        
        // Close the form modal
        onClose();
      } catch (error: any) {
        // Handle errors - display in error modal
  ...
  return (
    <>
      ...
      {/* Error Modal - Rendered after main modal so it appears on top */}
      <Modal 
      ...
      {/* Success Notification - Rendered last with highest z-index */}
      {showNotification && (
